...
use super::super::super::super::enums::{ActionsEnum, MultiValueEnum, ModesEnum, StatusCodesEnum, CommandsEnum, CurrentActionsEnum, CurrenciesEnum, BonusModesEnum};
...
pub struct Bonus {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub jackpot_positions: Option<Vec<Vec<MultiValueEnum>>> /* [[0,0,0],[0,0,"mini"],[0,0,0],[0,0,0],[0,0,0]] */,
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl From<server::Bonus> for Bonus {
	fn from(obj: server::Bonus) -> Self {
		Bonus {
			...
			init_bs_count: obj.init_bs_count.unwrap_or_default(),
...
#[derive(Debug, Serialize, Deserialize, Default, Clone)]
pub struct Context {
	pub actions: Vec<ActionsEnum> /* respin */,
	pub bonus: Bonus,
	pub current: CurrentActionsEnum /* bonus */,
	pub last_action: ActionsEnum /* bonus_init */,
