...
pub struct Bonus {
	...
	pub mps: Vec<Vec<i32>> /* [[1,1,2,1,1],[1,1,1,1,1],[2,1,1,2,2],[1,1,1,1,1],[2,1,1,1,1]] */,
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	pub orig_bs_v: Vec<Vec<MultiValueEnum>> /* [[0,0,400,0,0],[0,0,1000,0,0],[0,0,400,0,0],[0,0,7000,0,0],[0,0,400,0,0]] */,
...
impl From<server::Bonus> for Bonus {
	fn from(obj: server::Bonus) -> Self {
		Bonus {
			...
			orig_board: obj.orig_board.unwrap_or_default().clone(),
			orig_bs_v: obj.orig_bs_v.unwrap_or_default().clone(),
